  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-grey-100">
      <div className="flex flex-col bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <label htmlFor="email" className="self-start mb-1 text-gray-700 ">
          Email
        </label>
        <input
          onChange={(e) => setEmail(e.target.value)}
          className="border border-gray-300 dark:border-gray-600 bg-whit text-black dark:text-black placeholder-gray-400 dark:placeholder-gray-400 p-2 mb-2 w-full rounded"
          id="email"
          type="email"
          name="email"
        ...
        <label htmlFor="password" className="self-start mb-1 text-gray-700">
          Password
        </label>
        <input
          id="password"
        ...
        <label htmlFor="role" className="self-start mb-1 text-gray-700">
          Role
        </label>
        <select
          onChange={(e) => setRole(e.target.value)}
          className="border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white p-2 mb-2 w-full rounded"
        >
        ...
        <button
          ...
          className="bg-blue-500 text-white px-4 py-2 w-full mt-2 rounded cursor-pointer hover:bg-blue-700"
        >
          Register
        </button>
      </div>
